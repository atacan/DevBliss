...
That is the basics of tree-based navigation. Read the dedicated [TreeBasedNavigation](TreeBasedNavigation.md) article
...
[StackBasedNavigation](StackBasedNavigation.md) article for information on how to use the tools that come with the 
...
#### Pros of tree-based navigation
  ...
  * Tree-based navigation unifies all forms of navigation into a single, concise style of API, 
    ...
    [TreeBasedNavigation](TreeBasedNavigation.md)#API-Unification for more information.
...
the dedicated articles [TreeBasedNavigation](TreeBasedNavigation.md) and [StackBasedNavigation](StackBasedNavigation.md) to learn about the 
